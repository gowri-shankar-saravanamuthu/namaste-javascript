...
- Even after the outer function has finished executing (and its execution context is technically popped off the call stack), the returned inner function still has access to the outer function's variables.
