...
// - This works because in the **memory creation phase**, `x` is allocated memory and set to `undefined`, and `getName` has its entire function code stored in memory — before a single line of code executes.
